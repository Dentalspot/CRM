...
**Active feature**: — entre ciclos (2026-04-22). Último cerrado: `021-cleanup-fonokit-legacy` → 9 edge functions dead code eliminadas + 6 rebrandeadas (clinic-invitations, prepare-training-data, generate-ad-copy, marketplace-ai-description, send-marketing-campaign, meta-ads-manager). Diff -2,716 LOC netas. Repo coherente con branding DentalSpot. Follow-ups pendientes: **meta-spec `fix-mercadopago-critical-bugs`** P0 (16-22h, spec 019 BLOCKERs F-001/F-002/F-003/F-005 — pre-requisites ahora resueltos) + `add-subscription-plans-tier-model` P1 (10-14h, pricing tier real) + diferidos menores (og-preview si blog activa, AutomationPage.jsx refs outdated). Ver `docs/session-logs/2026-04-22-mp-deploy-and-diagnosis.md` + architecture.md §"Legacy FonoKit cleanup (spec 021)".
<!-- SPECKIT END -->
