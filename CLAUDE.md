...
**Active feature**: — entre ciclos (2026-04-22). **Spec 022 MVP Lean DONE** — App funcional para cobros. Phases A+B+C+D+G completas. Phases E (enforcement UX) + F (smoke E2E completo) diferidas a post-launch beta con riesgo aceptado. Siguiente paso: **launch beta con 5-10 dentistas usando cupón BETA-3M-2026** (100% off, 3 meses renovación) + monitoring manual. Follow-ups pendientes por prioridad: (1) meta-spec `fix-mercadopago-critical-bugs` P0 antes de scale a 100+ users (16-22h, F-001/F-002/F-003/F-005), (2) Phase E enforcement UX cuando se detecte abuso Free (3-5h), (3) Phase F smoke visual con usuarios beta reales (1-2h), (4) `create-clinical-boxes-table-and-enforcement` cuando se diseñe UX sillones. Ver `specs/022-add-plans-tier-model/quickstart.md §Phase E-F` para pickup cuando corresponda.
<!-- SPECKIT END -->
