...
- O escribí directamente a DentalSpot al email [placeholder: email@dentalspot.cl]
...
Para revocar, contactá a tu profesional o escribí a [placeholder: email].
...
Al usar v1 sin revisión legal, aceptás:
