...
const ShareBar = ({ title, url }) => {
  ...
  return (
    <div className="flex items-center gap-1 text-slate-400">
      ...
      <button onClick={() => { navigator.clipboard.writeText(`${title}\n\n🔗 ${url}\n\n#odontología #dentalspot #salud`); setCopied('ig'); setTimeout(() => setCopied(false), 2000); }} className="p-2 rounded-full hover:bg-primary hover:text-primary transition-colors relative" aria-label="Copiar para Instagram">
