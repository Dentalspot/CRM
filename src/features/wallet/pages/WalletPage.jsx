...
import { Wallet, ArrowDownLeft, ArrowUpRight, History, Banknote, Loader2, AlertCircle } from 'lucide-react';
import { fetchWallet, fetchTransactions, fetchWithdrawals, requestWithdrawal } from '../api/walletApi';
...
const WalletPage = () => {
  ...
  const handleRequestWithdrawal = async () => {
    ...
    if (!bankData.bankName || !bankData.accountNumber || !bankData.rut) {
      toast({ variant: 'destructive', title: 'Completa los datos bancarios' });
      return;
    }
  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      <Helmet><title>Mi Billetera | DentalSpot</title></Helmet>

      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Mi Billetera</h1>
          <p className="text-gray-500">Gestiona tus ganancias, retiros y transacciones.</p>
        </div>
      </div>
                  ...
                  {withdrawals.length === 0 ? (
                    ...
                    withdrawals.map((req) => (
                      <TableRow key={req.id}>
                        ...
                        <TableCell>
                          {req.estimated_completion_date ? format(new Date(req.estimated_completion_date), 'dd/MM/yyyy') : '-'}
                        </TableCell>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <Input 
                    ...
                    placeholder="Ej. Vista / Corriente" 
                  />
                </div>
              </div>
              <div className="space-y-1">
