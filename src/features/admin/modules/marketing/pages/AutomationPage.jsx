...
const AUTOMATIONS = [
  {
    ...
    implementation: 'Pendiente (edge functions eliminadas en spec 021 cleanup FonoKit)',
    status: false,
    stats: { sent: null, openRate: null },
    note: 'Deprecado. welcome-sequence + process-scheduled-emails eliminadas en spec 021 (cleanup FonoKit legacy). Re-implementar si DentalSpot activa automatización de onboarding de leads (pg_cron extension requiere activarse).',
  },
  {
    id: 'welcome_email',
    ...
    delay: 'Inmediato',
    template: 'Bienvenida',
    implementation: 'Pendiente (edge function on-user-created no existe)',
    status: false,
    stats: { sent: null, openRate: null },
    note: 'Pendiente de implementación. La edge function on-user-created referenciada no existe en el proyecto. Requiere crear la function + trigger Supabase Auth si se quiere activar.',
  },
  {
    id: 'feedback_popup',
