/**
 * @file ClinicalHistoryMetricsCard.jsx
 * @description KPI card reutilizable para el módulo clinical-history.
 */
...
const ClinicalHistoryMetricsCard = ({
...
export default ClinicalHistoryMetricsCard;
