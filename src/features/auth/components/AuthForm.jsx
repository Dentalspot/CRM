  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent>
        ...
        {/* Google Sign-In — solo en modo Login. En signup queda oculto porque
            el OAuth flow no propaga el rol seleccionado al metadata → trigger
            handle_new_user crea profile con role='patient' fallback, incluso
            si el user eligió "dentista". Solución completa pendiente: pasar
            role en options.data del signInWithOAuth + adjustar trigger para
            respetarlo. Mientras tanto, signup va siempre por email/password. */}
        {isLogin && (
          <>
