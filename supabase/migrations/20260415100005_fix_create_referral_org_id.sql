-- ============================================================
-- Fix create_referral RPC: agregar organization_id al INSERT
-- de clinical_history, derivado de patients.organization_id.
--
-- No cambia la firma del RPC ni el caller frontend.
-- No toca accept_referral ni associate_patient_to_therapist.
-- ============================================================
