...
- `clinical_access_log` append-only con triggers
...
- **Schema clínico compartido:** semántica de `patients`, `clinical_access_log`, `processing_lawful_basis`, `arco_requests` debe ser compatible cross-app
...
---
**Last updated**: 2026-04-19 | **Source**: Espejo adaptado del `ecosystem-communicare.md` de FONOKIT (memoria persistente, 2026-04-18)
